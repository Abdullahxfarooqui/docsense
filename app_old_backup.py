...
def main() -> None:
    ...
    try:
        ...
        if prompt := st.chat_input("Ask a question about your documents..." if has_documents else "Upload documents first to start chatting"):
            ...
            with st.chat_message("assistant"):
                ...
                try:
                    ...
                    with thinking_placeholder.container():
                        st.markdown("🤖 **Analyzing your question and searching documents...**")
                    
                    # Get query engine
                    query_engine = get_query_engine()
                    
                    # Retrieve with spinner
                    ...
                    if thinking_placeholder:
                        with thinking_placeholder.container():
                            st.markdown("🧩 **Generating detailed answer...**")
